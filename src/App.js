...
const TYPE_INDEX = 1; //TEST: 0=="look", 1=="hear", 2=="readLP",
...
const CARD_TYPES = ["look","hear","readLP", "readTranslit",
    "recall","writeDictation","readSign","makeSign","describePicture"];
const THEMES = ["zen-light","zenburn","black-board","index-card",'zen-dark'];
